...
contract Lw3Punks is ERC721Enumerable, Ownable {
    ...
    /**
     * @dev mint allows an user to mint 1NFT per transaction.
     */
    //mint function
        ...
        returns (string memory)
    {
        ...
        // Here it checks if the length of the baseURI is greater than 0, if its return the baseURI and attach
        // the tokenId and `.json` to it so that it knows tje location of the metadata json file for a given
        // tokenId stored  on IPFS
        // if the baseURI is empty return and empty string
        return
